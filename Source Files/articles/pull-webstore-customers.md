---
title: Pull customer data from the webstore
...
# Pull customer data from the webstore
...
<iframe width="350" height="197" loading="lazy" src="media/videos/pull-webstore-customers/pull-webstore-customers.html" title="Pull customer data from the webstore"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="border:1px solid; border-color:#0a0a0a;box-shadow:5px 5px 5px -5px #0a0a0a;border-radius:7px;margin-block-start:1em"></iframe>
