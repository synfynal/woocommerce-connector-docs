---
title: Push item category data to the webstore
...
# Push item category data to the webstore
...
1. On the <b>Synchronization</b> FastTab, under <b>Push Data To Webstore</b> in <b>Item Categories</b>, specify one of the following options:
     - <i>Mapped Only</i> : Synchronize mapped item category records from Business Central to your webstore.
     - <i>None</i> : Do not synchronize item category records from Business Central to your webstore.

## Demo video

<iframe width="350" height="197" loading="lazy" src="media/videos/push-webstore-item-categories/push-webstore-item-categories.html" title="Push item category data to the webstore"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="border:1px solid; border-color:#0a0a0a;box-shadow:5px 5px 5px -5px #0a0a0a;border-radius:7px;margin-block-start:1em"></iframe>
