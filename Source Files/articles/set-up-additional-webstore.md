...
1. Specify values for other fields in the same way as the initial webstore setup. To learn more, go to [Set up the WooCommerce Connector](set-up-woocommerce-connector.md).
